...
public class SwerveControl_old {
	...
	private static SwerveControl_old instance;

	public static SwerveControl_old getInstance() {
		if (instance == null) {
			instance = new SwerveControl_old();
		}
		return instance;
	}
